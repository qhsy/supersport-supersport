...
public class tls_sigature {
	...
	public static void main(String[] args) {
		try{			
			...
			"MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQgQBbcq07Vp/NwN/Fe9+87\n" +
			"e+rlMvjxgKqpqDpxiAeISemhRANCAAQV4R+Eo8bIVxoj+51sTMmypXHYvwBxOIpZ\n" +
			"wi8K7AJixP0IHu3toQ9l23d8tIR/cBXacoTwib+PzPLpz9nrJl4E\n" +
			"-----END PRIVATE KEY-----";
		    
			//change public pem string to public string
			String pubStr = "-----BEGIN PUBLIC KEY-----\n"+
			"MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEFeEfhKPGyFcaI/udbEzJsqVx2L8AcTiK\n"+
			"WcIvCuwCYsT9CB7t7aEPZdt3fLSEf3AV2nKE8Im/j8zy6c/Z6yZeBA==\n"+
			"-----END PUBLIC KEY-----";			

            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400010960, "godoadmin", privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400010960, "godoadmin", pubStr);
