...
public class CnMatchLink extends BaseEntity {
	...
	@ZooData(name = "跳转类型", require = "1",element = DefineWebElement.Select,inc = {DefineWebInc.System_Define + "=dzsd410710011005" })
	@Column(length=50)
	...
	@ZooData(name = "状态",element = DefineWebElement.Select,inc = {DefineWebInc.System_Define + "=dzsd410710011013" })
