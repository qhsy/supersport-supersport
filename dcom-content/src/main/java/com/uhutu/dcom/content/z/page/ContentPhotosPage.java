...
@ZooPage(name = "内容图集", pages = { DefineZooWeb.PAGE_DEFAULT_SUB }, operates = { DefineZooWeb.PAGE_DEFAULT_OPERATE,
		DefineWebPage.Page_Query + "=dzoi4699100110171001", DefineWebPage.Page_Add + "=dzoi41071026" }, deploy = {
				DefineWebDeploy.Url_Query + "=contentCode", DefineWebDeploy.Grid_Order + "=zc" })
