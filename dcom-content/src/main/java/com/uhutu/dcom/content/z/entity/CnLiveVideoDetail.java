...
public class CnLiveVideoDetail extends BaseEntity {
	...
	@ZooData(name = "点赞数", sort = { DefineWebPage.Page_Query + "=0" })
	private long praise;

	@ZooData(name = "观看人次", sort = { DefineWebPage.Page_Query + "=0" })
	private long watch;

	@ZooData(name = "时长", sort = { DefineWebPage.Page_Query + "=0" })
	private int length;

	@ZooData(name = "创建时间", sort = { DefineWebPage.Page_Query + "=0" })
	private String createTime;

	@ZooData(name = "结束时间", sort = { DefineWebPage.Page_Query + "=0" })
	...
	@ZooData(name = "直播流地址", sort = { DefineWebPage.Page_Query + "=0", DefineWebPage.Page_Grid + "=0" })
	private String streamUrl;

	@ZooData(name = "channelId", sort = { DefineWebPage.Page_Query + "=0", DefineWebPage.Page_Grid + "=0" })
