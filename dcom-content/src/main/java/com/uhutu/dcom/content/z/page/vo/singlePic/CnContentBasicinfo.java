package com.uhutu.dcom.content.z.page.vo.singlePic;
...
public class CnContentBasicinfo extends BaseEntity {
	...
	@ZooData(name = "封面", element = DefineWebElement.UploadAli, sort = { DefineWebPage.Page_Query + "=0",
	...
	@ZooData(name = "专题地址", require = "1", sort = { DefineWebPage.Page_Query + "=0", DefineWebPage.Page_Grid + "=0" })
