package com.uhutu.dcom.content.z.page.vo.otherLive;
...
public class CnContentDetail extends BaseEntity {
	...
	@ZooData(name = "直播房间号", element = DefineWebElement.Input, sort = { DefineWebPage.Page_Query + "=0",
			DefineWebPage.Page_Edit + "=0", DefineWebPage.Page_Add + "=0", DefineWebPage.Page_Grid + "=0" })
