...
@ZooPage(name = "内容管理(文章)", operates = DefineZooWeb.PAGE_DIALOG_OPERATE, deploy = DefineWebDeploy.Grid_Where
		+ "=content_type in ( 'dzsd4107100110030001','dzsd4107100110030002') ")
