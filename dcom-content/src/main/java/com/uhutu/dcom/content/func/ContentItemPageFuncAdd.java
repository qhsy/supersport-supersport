	...
	public WebOperateResult process(WebPageModel webPageModel, ExtendPageDefine extendPageDefine,
		...
		if ("dzsd4699100110060001".equals(input.getDataMap().get("type"))) {
			...
			List<CnContentItem> li = JdbcHelper.queryForList(CnContentItem.class, "", "",
					" type='dzsd4699100110060001' and ((endTime>:startTime and endTime<:endTime) or (startTime>:startTime and startTime<:endTime) or (startTime<:startTime and endTime>:endTime) or (startTime>:startTime and endTime<:endTime)) ",
					map);
