...
public class CnContentBasicinfo extends BaseEntity {
	...
	@ZooData(name = "内容标题", require = "1", verify = { DefineWebVerify.Max_Length + "=28" }, sort = {
			DefineWebPage.Page_Edit + "=0" })
	...
	@ZooData(name = "发布状态", element = DefineWebElement.Select, inc = {
			DefineWebInc.System_Define + "=dzsd469910011001" }, sort = { DefineWebPage.Page_Query + "=0",
					DefineWebPage.Page_Grid + "=0", DefineWebPage.Page_Edit + "=0" })
	private String status;

	@ZooData(name = "大分类", sort = { DefineWebPage.Page_Query + "=0", DefineWebPage.Page_Grid + "=0",
			DefineWebPage.Page_Edit + "=0" }, element = DefineWebElement.Model, inc = {
	...
	@ZooData(name = "业务类型", element = DefineWebElement.Select, inc = {
			DefineWebInc.System_Define + "=dzsd410710011002" }, sort = { DefineWebPage.Page_Query + "=0",
					DefineWebPage.Page_Grid + "=0", DefineWebPage.Page_Edit + "=0" })
	private String busiType;

	@ZooData(name = "内容类型", element = DefineWebElement.Select, inc = {
			DefineWebInc.System_Define + "=dzsd410710011003" }, sort = { DefineWebPage.Page_Edit + "=0" })
