...
public class ApiButtockLapList extends RootApiBase<ApiButtockLapListInput, ApiButtockLapListResult> {
	...
	protected ApiButtockLapListResult process(ApiButtockLapListInput input) {
		...
		int total = JdbcHelper.count(CnContentBasicinfo.class, "", MapHelper.initMap("tagCode","GGBH160718110001","status",ContentEnum.normal.getCode()));
		...
		String whereStr = "tagCode='GGBH160718110001' and status='"+ContentEnum.normal.getCode()+"'";
