...
public class AdvertiseMent {
	...
	@ApiModelProperty(name = "广告类型", notes = " 01:轮播图，03:单图", example = "01")
	private String type = "";
	...
	public List<AdvertiseDetailForApi> getDetails() {
		return details;
	}

	public void setDetails(List<AdvertiseDetailForApi> details) {
