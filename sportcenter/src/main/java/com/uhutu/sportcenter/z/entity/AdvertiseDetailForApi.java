...
public class AdvertiseDetailForApi {
	...
	@ApiModelProperty(name = "文章类型(piclinkType为dzsd4107100110050002时此参数有效)", notes = "dzsd4107100110030001:展示图文 ,dzsd4107100110030002:视频,dzsd4107100110030003:图集(piclinkType为dzsd4107100110050002时此参数有效)", example = "dzsd4107100110030001")
	private String type;
